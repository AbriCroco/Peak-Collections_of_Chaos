...
namespace Chaos.Manager
{
    public class RandomEventManager : MonoBehaviourPunCallbacks, IInRoomCallbacks, IOnEventCallback
    {
        ...
        public static bool AllowScoutmasterTimer = false;
        ...
        private void Start()
        {
            ...
            var go = GameObject.Find("Chaos_ScoutmasterTimer") ?? new GameObject("Chaos_ScoutmasterTimer");
            DontDestroyOnLoad(go);
            scoutmasterTimer = go.GetComponent<ScoutmasterTimer>() ?? go.AddComponent<ScoutmasterTimer>();
        }
